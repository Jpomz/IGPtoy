...
#'
#' @details This function re-scales a vector of environmental values for patches to carrying capacities. hte minimum carrying capacity = `0.5 * k_base` and the maximum carrying capacity = `1.5 * k_base`.
#'
