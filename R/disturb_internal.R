...
#' @param disturb_value Vector of numbers describing an environmental condition in patch `i`. This vector will be scaled from 0 to 1 using the inverse logit function. This is designed to take the output of `df_patch$environment` from `brnet()` as an input.
