...
test_that("get_fcl returns double value between (2,3)", {
  ...
  output <- get_fcl(N, obs_P_pref = seq(0, 1, length.out = 100))
  expect_lte(max(output), 3)
